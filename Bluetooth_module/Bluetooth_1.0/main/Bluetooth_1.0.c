...
#include "esp_bt.h"
#include "esp_gap_ble_api.h" #include "esp_gatts_api.h"
...
static uint8_t service_uuid128[] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 
...
#define GATTS_CHAR_UUID_TX 0x01

//#define GATTS_TX_CHARCTERISTIC_UUID 
//#define GATTS_RX_CHARCTERISTIC_UUID

static uint8_t adv_config_done = 0;
#define adv_config_flag       (1 << 0)
#define scan_rsp_config_flag  (1 << 1)

uint8_t char1_str[] = {0x11,0x22,0x33,0x44,0x55};
uint16_t a_property;
...
struct gatts_profile_inst {
    ...
    uint16_t char_handle1;
    esp_bt_uuid_t char_uuid1;
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_CREATE_EVT:
         ...
         gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TX;
    ...
    case ESP_GATTS_DISCONNECT_EVT:{
         ...
         ESP_LOGI(GATTS_TAG, "ClIENT DISCONNECTED, conn_id %d, reason %d", param->conn_id,param->reason);
         gl_profile_tab[PROFILE_A_APP_ID].conn_id = param->connect.conn_id;
